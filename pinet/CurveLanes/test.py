...
#            cv2.waitKey(0) 
    ...
    if p.mode == 1: # check model with video
...
#        test_image = cv2.imread("/home/cany/PINet_new-master/CULane/image.jpg")
        test_image = cv2.imread("/home/cany/lanefinder/pinet/CurveLanes/orig.png")
...
#        test_image = cv2.resize(ori_image, (800,448)) / 255.0
        test_image = np.rollaxis(test_image, axis=2, start=0)
        ...
        res = Image.fromarray(ti[0][...,[2,1,0]])
        res.save('/home/cany/lanefinder/pinet/CurveLanes/res.png')
